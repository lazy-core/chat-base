...
import User, { IUser } from "../models/user.model"; // your Mongoose model for users
import authConfig from "../config/auth.config"; // configuration file with secrets and expiry times
